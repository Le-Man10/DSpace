...
alter table bundle drop column IF EXISTS mets_bitstream_id;
...
DROP TABLE IF EXISTS ItemsByAuthor CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS ItemsByTitle CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS ItemsByDate CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS ItemsByDateAccessioned CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS ItemsBySubject CASCADE CONSTRAINTS;

DROP TABLE IF EXISTS History CASCADE CONSTRAINTS;
DROP TABLE IF EXISTS HistoryState CASCADE CONSTRAINTS;
...
CREATE INDEX IF NOT EXISTS bundle2bits_bitstream_fk_idx ON Bundle2Bitstream(bitstream_id);
